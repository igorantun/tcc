...
Palavras-chaves: Teoria do agendamento. Mídia. Redes sociais. Agenda pública. Eleições de 2022 no Brasil.
\end{resumo}
...
Keywords: Agenda-setting. News media. Social networks. Public agenda. 2022 Brazilian general election.
\end{otherlanguage*}
\end{resumo}
...
\chapter{Outra seção primária - sugestão ``Revisão bibliográfica''}
...
\chapter{Mais uma seção primária - sugestão ``Método''}
...
\chapter{Mais uma outra seção primária -   - sugestão ``Resultados e discussão''}
